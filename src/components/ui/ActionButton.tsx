  ...
  return (
    <button
      ...
      className={`
        ...
        ${buttonState === 'idle'
          ? 'bg-gray-700 dark:bg-zinc-300 text-white dark:text-zinc-900 hover:bg-gray-600 dark:hover:bg-zinc-200 active:scale-[0.98] shadow-[0_4px_14px_rgba(0,0,0,0.12)] dark:shadow-none'
          : buttonState === 'copied'
